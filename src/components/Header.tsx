        ...
        <div className="header_wrapper">
            <div className="header" >
                ...
                <div className="header_left_icons" >
                    ...
                    <div className="icon_box profile" onClick={() => setIsProfile(!isProfile)} ><img src="/header_icons/profile_pic.png" alt="" />
                    </div>
                    {isProfile && <Profile />}
                </div>
            </div>
        ...
        <div className="profile-dropdown">
            ...
            <div className="profile-header">
                ...
                <div>
                    ...
                    <span className="role">{data.data.user.roles[0].name}</span>
                </div>
