...
const StudentCategory = () => {
    ...
    return (
        <div className="page_wrapper">
            <div className="student_category">
                ...
                <TableWrapper onClick={handleAddAdmissionQuery} isAddButton isSearchBar title="Add Student Category" >
                    <DataTable
                        columns={columns}
                        data={sampleData}
                        currentPage={page}
