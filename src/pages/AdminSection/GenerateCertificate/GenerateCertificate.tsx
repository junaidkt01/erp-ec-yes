...
const GenerateCertificate = () => {
    ...
    return (
        <div className="page_wrapper">
            <div className="generate_certificate_page">
                <TableWrapper title={"Generate Certificate"} onClick={handleAddAdmissionQuery} >
                    <div className="search_screen">
                        ...
                        <div className="popup_body" >
                            <div className="body_section" >
                                ...
                                <CustomSelect label="Certificate" placeholder="Select certificate" onChange={(val) => console.log("Selected:", val)} />
                            </div>
