...
const DisabledStudents = () => {
    ...
    return (
        <div className="page_wrapper">
            <div className="disabled_students">
                {isAddAdmissionQuery && <PopupScreen title="Add Disabled Students" onClick={handleAddAdmissionQuery} >
                ...
                <TableWrapper isAddButton title="Disabled Students" onClick={handleAddAdmissionQuery} >
