...
export const PrimaryButton = ({ title, type, onClick }: { title: string; type?: "button" | "submit" | "reset"; onClick?: any }) => {
    return (
        <button className="button primary_button" onClick={onClick} type={type} >
            {title}
        </button>
    )
}
