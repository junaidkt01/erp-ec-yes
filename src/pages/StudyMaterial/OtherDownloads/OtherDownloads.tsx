// we can remove the input field if no add button
...
const OtherDownloads = () => {
    ...
    const sampleData = [
        {
            sl: "1",
            content_title: "Science Project Guidelines",
            type: "Homework",
            date: "03-04-2025",
    ...
    return (
        <div className="page_wrapper">
            <div className="other_downloads_page" >
                ...
                <TableWrapper isSearchBar title="Other Downloads List" onClick={handleAddComplaint} >
                    <DataTable
                        columns={columns}
                        data={sampleData}
                        currentPage={page}
